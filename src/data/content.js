...
export const content = {
  en: {
    ...
    services: {
      ...
      fertilizersTitle: 'Fertilizers & Nutrition',
      fertilizersDesc: 'Premium fertilizers, micro-nutrients, and soil health products for maximum crop yield.',
    ...
    enquiry: {
      ...
      subheading: 'Leave your number and we\'ll call you back within 2 hours (Mon–Sat, 9AM–6PM).',
      namePlaceholder: 'Your Full Name',
      phonePlaceholder: 'Phone Number',
      emailPlaceholder: 'Email Address (optional)',
      messagePlaceholder: 'Your question or which property / area you are interested in...',
      submit: 'Request a Callback',
      sending: 'Sending...',
      successTitle: 'We\'ll Call You Back!',
      successMsg: 'Thank you! Our team will call you within 2 hours. If urgent, call us now: 7780312525.',
  ...
  te: {
    ...
    services: {
      ...
      fertilizersTitle: 'ఎరువులు & పోషణ',
      fertilizersDesc: 'గరిష్ట పంట దిగుబడి కోసం మెరుగైన ఎరువులు, మైక్రో-న్యూట్రియెంట్స్ మరియు మట్టి ఆరోగ్య ఉత్పత్తులు.',
    ...
    enquiry: {
      heading: 'మాతో మాట్లాడండి',
      subheading: 'మీ నంబర్ వదిలిపెట్టండి — మా టీమ్ 2 గంటల్లోపు కాల్ చేస్తుంది (సోమ–శని, 9–6).',
      namePlaceholder: 'మీ పూర్తి పేరు',
      phonePlaceholder: 'ఫోన్ నంబర్',
      emailPlaceholder: 'ఇమెయిల్ చిరునామా (ఐచ్ఛికం)',
      messagePlaceholder: 'మీ ప్రశ్న లేదా ఆసక్తి ఉన్న ప్రాంతం...',
      submit: 'కాల్‌బ్యాక్ అభ్యర్థించండి',
      sending: 'పంపుతోంది...',
      successTitle: 'మేము కాల్ చేస్తాము!',
      successMsg: 'ధన్యవాదాలు! మా టీమ్ 2 గంటల్లోపు కాల్ చేస్తుంది. అర్జెంట్ అయితే: 7780312525.',
